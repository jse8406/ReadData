...
// update
const yValrate2024 = [[6.82, 11.36, 11.36, 2.27, 20.45, 13.64, 6.82, 6.82, 9.09, 11.36, 0.0, 0.0], [6.25, 17.19, 12.5, 6.25, 15.62, 6.25, 6.25, 15.62, 10.94, 3.12, 0.0, 0.0], [2.22, 31.11, 13.33, 6.67, 15.56, 4.44, 2.22, 2.22, 20.0, 2.22, 0.0, 0.0], [0.0, 23.08, 5.13, 7.69, 17.95, 10.26, 2.56, 15.38, 5.13, 12.82, 0.0, 0.0], [2.5, 17.5, 5.0, 20.0, 17.5, 7.5, 0.0, 12.5, 12.5, 5.0, 0.0, 0.0], [4.35, 21.74, 15.22, 4.35, 8.7, 15.22, 10.87, 6.52, 8.7, 4.35, 0.0, 0.0]]
// 물품 수량 정보
const yValamt2020 = [
...
const yValamt2024 = [[3, 5, 5, 1, 9, 6, 3, 3, 4, 5, 0, 0], [4, 11, 8, 4, 10, 4, 4, 10, 7, 2, 0, 0], [1, 14, 6, 3, 7, 2, 1, 1, 9, 1, 0, 0], [0, 9, 2, 3, 7, 4, 1, 6, 2, 5, 0, 0], [1, 7, 2, 8, 7, 3, 0, 5, 5, 2, 0, 0], [2, 10, 7, 2, 4, 7, 5, 3, 4, 2, 0, 0]]
// 용역 비율 정보
 ...
 [1.64, 6.56, 8.2, 19.67, 13.11, 8.2, 8.2, 6.56, 4.92, 6.56, 6.56, 9.84],
  [2.56, 2.56, 7.69, 12.82, 15.38, 2.56, 10.26, 2.56, 7.69, 10.26, 12.82, 12.82],
   [0.0, 4.35, 13.04, 15.22, 8.7, 4.35, 10.87, 8.7, 2.17, 4.35, 15.22, 13.04],
    ...
    [[8.7, 8.7, 4.35, 21.74, 21.74, 4.35, 17.39, 4.35, 8.7, 0.0, 0.0, 0.0], [2.94, 8.82, 5.88, 20.59, 23.53, 17.65, 2.94, 2.94, 11.76, 2.94, 0.0, 0.0], [5.56, 16.67, 2.78, 13.89, 16.67, 11.11, 13.89, 5.56, 11.11, 2.78, 0.0, 0.0], [0.0, 12.5, 12.5, 16.67, 29.17, 4.17, 16.67, 0.0, 8.33, 0.0, 0.0, 0.0], [4.55, 13.64, 9.09, 36.36, 18.18, 13.64, 0.0, 4.55, 0.0, 0.0, 0.0, 0.0], [6.67, 16.67, 0.0, 10.0, 26.67, 20.0, 3.33, 6.67, 10.0, 0.0, 0.0, 0.0]]
// 용역 수량 정보
...
const yValamt2024yy = [[2, 2, 1, 5, 5, 1, 4, 1, 2, 0, 0, 0], [1, 3, 2, 7, 8, 6, 1, 1, 4, 1, 0, 0], [2, 6, 1, 5, 6, 4, 5, 2, 4, 1, 0, 0], [0, 3, 3, 4, 7, 1, 4, 0, 2, 0, 0, 0], [1, 3, 2, 8, 4, 3, 0, 1, 0, 0, 0, 0], [2, 5, 0, 3, 8, 6, 1, 2, 3, 0, 0, 0]]
